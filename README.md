...
| market-svc | Kotlin · Spring WebFlux · WebSocket · Redis | 8085 |
...
| 메서드 | 경로 | 서비스 | 설명 |
|--------|------|--------|------|
| `WS` | `ws://localhost:8085/ws/quotes/{symbol}` | market-svc | 실시간 시세 스트리밍 (3초 간격) |
| `GET` | `http://localhost:8085/actuator/health` | market-svc | 헬스체크 |
| `POST` | `http://localhost:8083/debate/request` | ai-debate-svc | 토론 요청 시작 |
